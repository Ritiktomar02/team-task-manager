...
The first time the server boots against an empty database it auto-seeds a sample
project ("Product Launch") with three users and five tasks (one overdue). Click
**Admin** or **Member** on the login screen to one-click sign in — or use:

| Role   | Email                      | Password    |
| ------ | -------------------------- | ----------- |
| Admin  | `demo.admin@example.com`   | `Demo@123`  |
| Member | `demo.member@example.com`  | `Demo@123`  |
| Member | `sara@example.com`         | `Demo@123`  |

Sign in as **Admin** to see project edit/delete, member management, and task creation.
Sign in as **Member** to see how RBAC restricts editing — members can only update
status on tasks assigned to them.
